...
export class NevLogo extends Component {
  render() {
    return (
        ...
        <line x1="186" y1="268" x2="243" y2="298" stroke="black" strokeWidth="3"></line>
        ...
        <text x="193" y="308" fontSize="13" fill="white">Study</text>
        <text x="228" y="228" fontSize="18" fill="white">Hub</text>
        <text x="273" y="308" fontSize="13" fill="white">Note</text>
        ...
        <text x="146" y="356" fontFamily="Algerian" fontSize="27" fill="red">StudyHubNote</text>
